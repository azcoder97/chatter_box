...
class ChatScreen extends StatelessWidget {
  ...
  ChatScreen({super.key, required this.userName, required this.avatarUrl});

  final chatController =
      Get.find<ChatController>(); // ✅ Get controller instance
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: TextField(
                    controller: chatController
                        .messageController, // ✅ Controller from GetX
                    decoration: InputDecoration(
                      hintText: "Type a message...",
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(30),
                ...
                GestureDetector(
                  onTap: () =>
                      chatController.sendMessage(), // ✅ Just call controller
                  child: CircleAvatar(
                    radius: 25,
                    backgroundColor: Colors.deepPurple,
                    child: const Icon(Icons.send, color: Colors.white),
